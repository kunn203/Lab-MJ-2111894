...
df=pd.read_csv('D:/Python/MiniProject/ds_salaries.csv')
...
plt.title('Tổng số lượng các cấp bậc công việc',fontsize=13)
...
plt.title('Tổng số lượng các loại công ty',fontsize=13)
...
plt.ylabel("Cấp bậc")
plt.title('Mức lương cao nhất theo từng bậc',fontsize=13)
